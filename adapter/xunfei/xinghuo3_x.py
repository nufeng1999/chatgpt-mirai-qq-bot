...
from config import Xinghuo3_x_CookiePath
...
import random
# import SparkApi
from .SparkApi import V3BotClient
...
class Xinghuo3_x_Adapter(BotAdapter):
    """
    Credit: https://github.com/dfvips/xunfeixinghuo
    """
    account: Xinghuo3_x_CookiePath

    def __init__(self, session_id: str = ""):
        super().__init__(session_id)

        self.session_id = session_id
        self.account = botManager.pick('xinghuo3-x-cookie')
    ...
    async def ask(self, prompt) -> Generator[str, None, None]:
        ...
        logger.debug(f"[Xinghuo3_x] - {full_response}")
