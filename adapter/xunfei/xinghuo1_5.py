...
from config import Xinghuo1_5_CookiePath
...
import random
# import SparkApi
from .SparkApi import V1BotClient
...
class Xinghuo1_5_Adapter(BotAdapter):
    """
    Credit: https://github.com/dfvips/xunfeixinghuo
    """
    account: Xinghuo1_5_CookiePath

    def __init__(self, session_id: str = ""):
        super().__init__(session_id)

        self.session_id = session_id
        self.account = botManager.pick('xinghuo1-5-cookie')
    ...
    async def ask(self, prompt) -> Generator[str, None, None]:
        ...
        logger.debug(f"[Xinghuo1_5] - {full_response}")
